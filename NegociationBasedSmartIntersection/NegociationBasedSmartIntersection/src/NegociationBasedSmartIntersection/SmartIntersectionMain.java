...
public class SmartIntersectionMain {
	...
	public static int flowCarNumber = 10;
	...
	public static void main(String[] args) {
		...
		argument = argument+"FlowSimulationAgent:NegociationBasedSmartIntersection.FlowSimulationAgent(FSA);";
		argument = argument+"IntersectionAgent:NegociationBasedSmartIntersection.IntersectionAgent(IA);";
		for (int i = 1; i < (approachNumber+1); i++) {
			for (int j = 0; j < flowCarNumber; j++) {
				argument = argument + "C"+ i +"-"+ j + ":NegociationBasedSmartIntersection.CarAgent(car);";
			}
		}// action
