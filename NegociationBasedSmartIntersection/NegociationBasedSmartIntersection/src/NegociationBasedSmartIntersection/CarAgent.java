...
import static NegociationBasedSmartIntersection.SmartIntersectionMain.leavedCarsNumber;
...
public class CarAgent extends Agent {
	...
	public class RequestMovingState extends OneShotBehaviour {
		...
		private void sendRequestMessage() {
				...
				message.setContent("RequestMoving#" + getApproach() + "#" + getX() + "#" + getY() + "#" + getMyRequestedX() + "#" + getMyRequestedY() + "#" + getClock());
				send(message);
				setMyState("Waiting");
		}
	}
	...
	public class TerminateState extends OneShotBehaviour {
		int carsNumberOnScreen;
		@Override
		public void action() {
			String agentName = getLocalName();
			setMyState("Terminating") ;
			carsNumberOnScreen = leavedCarsNumber.incrementAndGet();
			System.out.println("========================I m the car : " + getLocalName() + ", I'm at the limit, at position (" + getX() + "," + getY() + ") on the approach " + getApproach() + " I m the "+carsNumberOnScreen+ " cars that leaved the system");
			ACLMessage message = new ACLMessage(ACLMessage.REQUEST);
			message.addReceiver(new AID("IntersectionAgent", AID.ISLOCALNAME));
