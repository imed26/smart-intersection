...
import static DynamicFlowSmartIntersection.SmartIntersectionMain.carNumber;
import static DynamicFlowSmartIntersection.SmartIntersectionMain.flowCarNumber;
import static DynamicFlowSmartIntersection.SmartIntersectionMain.approachNumberPerLine;
import static DynamicFlowSmartIntersection.SmartIntersectionMain.intersectionLineNumber;
...
public class FlowSimulationAgent extends Agent {
    ...
    public void commitAgent(int i, int j, int x, int y, int duration) {
        ...
        message.setContent("Commit#" + x + "#" +  y + "#" +  i + "#" + nextTime(duration, flowCarNumber));
        send(message);
    }
